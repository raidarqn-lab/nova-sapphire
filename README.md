...
**The public board contains visibly labelled demonstration data.** Names, scores, territory status, and event/train times are not real. Dates intentionally remain fixed to the sample week rather than pretending to be live.
